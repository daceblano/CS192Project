...
<body>
	...
	<form class="form-horizontal" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" method="post" >
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="nickname" value="<?php echo $result['nickname'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="first_name" class="col-sm-2 control-label">First Name</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="first_name" value="<?php echo $result['first_name'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="last_name" class="col-sm-2 control-label">Last Name</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="last_name" value="<?php echo $result['last_name'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="middle_name" class="col-sm-2 control-label">Middle Name</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="middle_name" value="<?php echo $result['middle_name'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="birthday" class="col-sm-2 control-label">Birth Date</label>
			<div class="col-sm-4">
				<input type="date" class="form-control" id="birthday" value="<?php echo $result['birthday'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="degree_program" class="col-sm-2 control-label">Degree Program</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="degree_program" value="<?php echo $result['degree_program'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="mail_main" class="col-sm-2 control-label">E-mail 1</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="mail_main" value="<?php echo $result['mail_main'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="mail_alt" class="col-sm-2 control-label">E-mail 2</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="mail_alt" value="<?php echo $result['mail_alt'];?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="num_globe" class="col-sm-2 control-label">Phone Number (Globe)</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="num_globe" value="<?php 
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="num_smart" value="<?php 
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input type="text" class="form-control" id="num_sun" value="<?php 
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="landline" value="<?php 
